         ...
         <h2 className ="title">Contact</h2>
          ...
          <Row className="work">
             <Col>
              ...
              <h6><b>Drop me a note! - <a href="mailto:jose.c.medina@me.com" target="_blank" className="contactMe">E-mail</a></b></h6>
             </Col>                       
          </Row>
          <br></br>
          <Row className="work">
          ...
          <Row className="work">
             <Col>
              ...
              <h6><b>Let's connect - <a href="https://www.linkedin.com/in/josecmedinajr/" target="_blank" className="contactMe">LinkedIn</a></b></h6>
             </Col>               
          </Row>
          <br></br>
          <Row className="work">
             ...
             <img src={twitter} height="50px" alt="twitter" />
              <h6><b>Follow me - <a href="https://twitter.com/JCMLV" target="_blank" className="contactMe">Twitter</a></b></h6>
             </Col>              
          </Row>
            </Container>
        </div>
